...
class StatAndAttributeEngine @Inject constructor() {
    ...
    fun calculateStatChange(character: CharacterEntity, activityType: String, duration: Int = 1): Map<String, Double> {
        return when (activityType.lowercase()) {
            ...
            "find_date" -> mapOf("happiness" to 5.0, "energy" to -10.0)
            "dating_app" -> mapOf("happiness" to 3.0, "energy" to -5.0, "cash" to -10.0)
            "adopt_child" -> mapOf("happiness" to 10.0, "cash" to -25000.0)
            "spend_time_family" -> mapOf("happiness" to 5.0, "energy" to -5.0)
            "medical_checkup" -> mapOf("health" to 10.0, "smarts" to 2.0, "cash" to -500.0)
            "surgery" -> mapOf("health" to 50.0, "energy" to -80.0, "cash" to -20000.0, "stress" to 20.0)
            "vaccination" -> mapOf("health" to 20.0, "energy" to -5.0, "cash" to -200.0)
            "physical_therapy" -> mapOf("health" to 25.0, "athleticism" to 5.0, "cash" to -1000.0, "energy" to -20.0)
            // MILITARY activities
