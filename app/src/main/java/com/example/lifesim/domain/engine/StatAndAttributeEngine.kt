...
class StatAndAttributeEngine @Inject constructor() {
    ...
    fun calculateStatChange(character: CharacterEntity, activityType: String, duration: Int = 1): Map<String, Double> {
        return when (activityType.lowercase()) {
            "gym" -> mapOf("athleticism" to 5.0*duration, "health" to 3.0*duration, "energy" to -4.0*duration, "looks" to 1.0*duration)
            "study" -> mapOf("smarts" to 6.0*duration, "energy" to -3.0*duration, "stress" to 3.0*duration)
            "meditate" -> mapOf("stress" to -8.0*duration, "happiness" to 3.0*duration, "sanity" to 3.0*duration)
            "socialize" -> mapOf("happiness" to 5.0*duration, "charisma" to 2.0*duration, "energy" to -2.0*duration)
            "work" -> mapOf("smarts" to 2.0*duration, "stress" to 4.0*duration, "cash" to 5000.0*duration)
            "crime" -> mapOf("aggression" to 3.0*duration, "notoriety" to 5.0*duration, "karma" to -5.0*duration)
            "party" -> mapOf("happiness" to 8.0*duration, "energy" to -6.0*duration, "stress" to -3.0*duration, "hygiene" to -2.0*duration)
            "travel" -> mapOf("happiness" to 10.0*duration, "smarts" to 3.0*duration, "cash" to -2000.0*duration, "stress" to -5.0*duration)
            "eat" -> mapOf("hunger" to 25.0*duration, "happiness" to 3.0*duration, "cash" to -30.0*duration)
            "sleep" -> mapOf("energy" to 30.0*duration, "health" to 2.0*duration, "stress" to -5.0*duration)
            "shower" -> mapOf("hygiene" to 40.0, "happiness" to 2.0)
            "therapy" -> mapOf("sanity" to 10.0*duration, "stress" to -8.0*duration, "cash" to -150.0*duration)
            "rehab" -> mapOf("addictionSeverity" to -3.0*duration, "health" to 5.0*duration, "cash" to -5000.0*duration)
            ...
            "gamble" -> mapOf("stress" to -3.0*duration, "cash" to -200.0*duration, "smarts" to 2.0*duration, "addiction_gambling" to 1.0)
